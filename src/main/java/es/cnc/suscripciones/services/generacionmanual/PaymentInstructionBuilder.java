...
import com.sepa.domain.v008.v001.v02.AccountIdentification4Choice;
import com.sepa.domain.v008.v001.v02.ActiveOrHistoricCurrencyAndAmount;
import com.sepa.domain.v008.v001.v02.BranchAndFinancialInstitutionIdentification4;
import com.sepa.domain.v008.v001.v02.CashAccount16;
import com.sepa.domain.v008.v001.v02.ChargeBearerType1Code;
import com.sepa.domain.v008.v001.v02.DirectDebitTransaction6;
import com.sepa.domain.v008.v001.v02.DirectDebitTransactionInformation9;
import com.sepa.domain.v008.v001.v02.FinancialInstitutionIdentification7;
import com.sepa.domain.v008.v001.v02.GenericPersonIdentification1;
import com.sepa.domain.v008.v001.v02.LocalInstrument2Choice;
import com.sepa.domain.v008.v001.v02.MandateRelatedInformation6;
...
import com.sepa.domain.v008.v001.v02.PaymentIdentification1;
import com.sepa.domain.v008.v001.v02.PaymentInstructionInformation4;
import com.sepa.domain.v008.v001.v02.PaymentMethod2Code;
import com.sepa.domain.v008.v001.v02.PaymentTypeInformation20;
import com.sepa.domain.v008.v001.v02.PersonIdentification5;
import com.sepa.domain.v008.v001.v02.RemittanceInformation5;
...
public class PaymentInstructionBuilder {
	...
	/**
	 * <DrctDbtTxInf> List
	 * Recorre las emisiones de una cabecera para crear los adedudos
	 * @param cabecera
	 * @return
	 * @throws DatatypeConfigurationException
	 */
